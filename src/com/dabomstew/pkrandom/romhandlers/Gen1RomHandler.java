...
public class Gen1RomHandler extends AbstractGBRomHandler {
	...
	public void fixTrainerAI() {
		...
		String modTable = "";
	...
	public int getNewLevel(int level, Trainer tr) {
		if(tr != null) {
			if(tr.trainerclass == 34) {
				// Brock
				return level - 2;
			} else if(tr.trainerclass == 5 && tr.trainerindex == 0) {
				// Brock's trainer
				return level - 2;
